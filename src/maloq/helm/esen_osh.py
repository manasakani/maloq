...
class eSEN_Backbone(nn.Module):
    ...
    def __init__(
        ...
        # Atom embedding. Paper-era HELM can use only the element identity;
        # the default keeps the original element/charge/spin parameter layout.
