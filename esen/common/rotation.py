...
def init_edge_rot_mat_old(edge_distance_vec, rot_clip=False):
    """
    ...
    edge_vec_2 = torch.rand_like(edge_vec_0) - 0.5  # CHANGE

    # edge_vec_2 = torch.tensor([[-0.0314, -0.3738, 0.0202], 
    #                             [-0.0544, 0.2421, -0.0909],
    #                             [0.1558, 0.3958, -0.4238], 
    #                             [0.1494, 0.2234, 0.1366],
    #                             [0.0242, -0.4878, 0.3486], 
    #                             [-0.1562, 0.2418, -0.4291]], device='cuda:0')
