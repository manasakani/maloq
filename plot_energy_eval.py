...
# eval_datasets = ['eval_2k']
eval_datasets = ['outputs_nablaDFT_energytrained_tiny/eval_2k', 'outputs_nablaDFT_focktrained_tiny/eval_2k']
...
combined_data = combined_data[combined_data['metric'].isin(['total'])]
