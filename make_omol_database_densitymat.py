...
def main():
    ...
    for folder_idx, structure_folder in enumerate(structures_to_process):
        ...
        # imshow density matrices and save to file:
        # import matplotlib.pyplot as plt
        # plt.imshow(np.log(np.abs(matrix)+1e-10))
        # plt.colorbar()
        # plt.savefig(f"alpha_{args.matrix_type}_{args.job_id}_{folder_idx}.png", dpi=300)
        # plt.close()
