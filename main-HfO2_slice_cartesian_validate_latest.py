...
def main(folder):
    ...
    if train_or_test == 'train':
        ...
        training.train_and_validate_model_subgraph(model, optimizer, data_loader, validation_loader, num_epochs, loss_tol, patience, threshold, save_file=save_file, schedule=True, dtype=dtype)
