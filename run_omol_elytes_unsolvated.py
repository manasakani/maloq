...
# ---------------------------
# --> OMOL
dataset_folder = '/capstor/store/cscs/pasc/c33/manasa/omol_datasets/omol_electrolytes_unsolvated_fock/'
total_rows = 28800
output_folder = 'outputs_omol_electrolytes_fock'
dataset_name = 'omol'
...
# --> Model settings:
matrix_type = 'fock'                 # 'fock' or 'density'
...
target_edges_per_batch = 10000          # Don't use more than 18k (for E128)
...
scale_and_shift = True if matrix_type == 'fock' else False
...
# 3. Update local molecule counts
