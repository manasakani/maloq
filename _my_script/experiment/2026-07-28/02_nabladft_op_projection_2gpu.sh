...
RUNNER=${SCRIPT_ROOT}/run_nabladft_op_projection.py
CONFIG=${SCRIPT_ROOT}/nabladft_op_projection.yaml
NABLA_DB=/dataset/seongsu/shared-home/datasets/nablaDFT/hamiltonian_databases/train_2k.db
RUN_PREFIX=nabladft-ntev2-op-projection-full-val-matrix-metrics-v4
