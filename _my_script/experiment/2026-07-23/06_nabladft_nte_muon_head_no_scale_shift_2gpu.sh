...
DEFAULT_GPUS=6,7
DEFAULT_MASTER_PORT=29612

PROJECT_ROOT=/dataset/seongsu/shared-home/workspace/project
EXPERIMENT_NAME=nabladft-nte-do128-le3-muon-head-no-scale-shift
MODEL_CONFIG=${PROJECT_ROOT}/_my_script/experiment/2026-07-23/maloq_nte_do128_le3_muon_head_nabladft.yaml
