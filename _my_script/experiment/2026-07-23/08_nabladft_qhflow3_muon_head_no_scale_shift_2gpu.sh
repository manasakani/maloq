...
# QHFlow3-clean + corrected Muon head, without label scale-shift.
# Edit this default or pass a pair as the second argument, e.g. "full 2,3".
DEFAULT_GPUS=0,1
DEFAULT_MASTER_PORT=29614

PROJECT_ROOT=/dataset/seongsu/shared-home/workspace/project
EXPERIMENT_NAME=nabla-qhf3-muon-ss0-v2
MODEL_CONFIG=/dataset/seongsu/shared-home/workspace/project/_my_script/experiment/2026-07-23/qhflow3_local_muon_head_nabladft.yaml
