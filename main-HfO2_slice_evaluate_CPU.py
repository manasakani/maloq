...
def main(folder):
    ...
    # Parameters:
    restart_file = 'model_HfO2_1_subgraph_CPU_CPU.pt'
    ...
    if test_data is not None:
        ...
        training.analyze_model(model, test_data, construct_kernel, equivariant_blocks, atom_orbitals, out_slices, device)
