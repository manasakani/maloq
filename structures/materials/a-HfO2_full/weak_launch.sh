...
python train.py -f /capstor/scratch/cscs/amaeder/ -rcut $rcut -nccl $nccl -overlap $overlap -hidden_dim $hidden_dimension -num_epochs 120 -is_reorder $reorder -reorder_method $reorder_method -tile_x $tile_x > ${out_folder}/output_\${SLURM_PROCID}_\${SLURM_NTASKS}.txt'
EOL
