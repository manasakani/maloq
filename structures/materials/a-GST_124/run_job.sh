...
#SBATCH --output=out_sparse_small/output_%j.txt
...
python train.py -f /users/amaeder/amorphous_gnns/ > out_sparse_small/output_${SLURM_PROCID}_${SLURM_NTASKS}.txt'