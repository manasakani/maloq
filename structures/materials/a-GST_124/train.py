...
def main(folder):
    ...
    # ************************************************************
    # Input parameters for the GST dataset
    # ************************************************************

    train_data_folder = os.path.join(folder, 'datasets/GST_1')
    val_data_folder = os.path.join(folder, 'datasets/GST_2')
    tag = 'a-GST_124'                                                                    # String tag for the output files
    ...
    pbc = True
    orbital_basis = 'DZVP'
    rcut = 3.0     # increase                                                                 # Interaction radius (1/2*rcut) in Angstroms
    lmax = 4     
    mmax = 4
    ...
    a_GST_124_train = structure.Structure(os.path.join(train_data_folder, 'structure.xyz'), 
    ...
    # a_GST_124_train.get_max_interaction_radius(eps=0)
    ...
    numbers = a_GST_124_train.atomic_numbers                                              # Atomic numbers of each atom in the structure
