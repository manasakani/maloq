...
database = HamiltonianDatabase("/capstor/store/cscs/pasc/c33/manasa/train_2k.db")
dataset_name = 'nablaDFT'
run_name = 'nabla_2k'
output_folder = 'outputs_nabla_2k'
# ---------------------------
...
num_val = 10#64                             # Number of validation structures
